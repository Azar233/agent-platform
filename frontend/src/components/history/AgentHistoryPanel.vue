...
.agent-badge { display: inline-flex; align-items: center; gap: 7px; font-weight: 700; }.agent-badge i { width: 8px; height: 8px; border-radius: 50%; background: #0071e3; }.agent-badge.dataset i { background: #8b5cf6; }.agent-badge.training i { background: #0ea5e9; }.agent-badge.catalog i { background: #f59e0b; }.agent-badge.knowledge i { background: #10b981; }.request-copy { color: $text-primary; }
